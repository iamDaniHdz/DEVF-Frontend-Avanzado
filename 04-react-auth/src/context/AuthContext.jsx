...
export function AuthProvider (props) {
  ...
  const loginUser = (token) => {
    ...
    // LocalStorage podemos persistir data en el navegador del cliente y permanece la data aun si se cierra la pestaña o se actualiza el navegador
    ...
    setIsAuth(true) // Seteamos el state de is auth en true (esta autenticado)
  }
